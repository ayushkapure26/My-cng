...
class GeminiAiHelper {
    ...
    // Remote generation stays disabled until an authenticated, quota-limited server is deployed.
    ...
    private fun callGeminiRaw(prompt: String): String =
        error("Online AI requires an authenticated server endpoint. Offline guidance is available.")
